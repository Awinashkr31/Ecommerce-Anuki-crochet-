  ...
  return (
    <section className="bg-white py-8">
      ...
      <div className="max-w-[100vw] px-4 md:max-w-7xl mx-auto mb-6">
        <div className="bg-gradient-to-r from-[#e4f1d3] via-[#d0ebaf] to-[#e4f1d3] w-full rounded-md py-6 px-4 flex flex-col items-center justify-center relative overflow-hidden shadow-sm">
      ...
      <div className="max-w-[100vw] xl:max-w-7xl mx-auto">
        <div className="flex overflow-x-auto snap-x snap-mandatory gap-0 md:gap-2 pb-6 hide-scrollbar px-2 md:px-4">
          {epicDeals.map((deal, index) => {
            ...
            <div key={deal.id} className="snap-start shrink-0 w-[220px] md:w-[260px] relative group px-2 py-2"> 
              {/* Border Container */}
              <div className="border-[4px] border-[#178524] rounded-xl flex flex-col h-[280px] md:h-[320px] relative shadow-sm">
