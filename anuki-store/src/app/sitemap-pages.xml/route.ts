...
export async function GET() {
  ...
  const pages = [
    ...
    { loc: '/gifts/under-300', freq: 'weekly', prio: '0.8' },
    { loc: '/gifts/under-500', freq: 'weekly', prio: '0.8' },
    { loc: '/gifts/under-1000', freq: 'weekly', prio: '0.8' },
    { loc: '/gifts/birthday', freq: 'monthly', prio: '0.8' },
    { loc: '/gifts/anniversary', freq: 'monthly', prio: '0.8' },
    { loc: '/gifts/valentines-day', freq: 'monthly', prio: '0.8' },
    { loc: '/gifts/raksha-bandhan', freq: 'monthly', prio: '0.8' },
