    ...
    >
      <div className="relative aspect-[4/5] bg-neutral-100 rounded-[20px] overflow-hidden block">
        ...
        <button 
          ...
          className="absolute top-4 right-4 z-20 w-8 h-8 bg-white/90 backdrop-blur rounded-full flex items-center justify-center text-neutral-400 hover:text-rose-500 hover:bg-white shadow-sm transition-all duration-300"
        >
          <Heart size={16} />
        </button>
