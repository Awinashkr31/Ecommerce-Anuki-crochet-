      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
        <div>
          ...
          <p className="text-sm text-neutral-500">
            Placed on {new Date(order.createdAt).toLocaleDateString()} • {order.items.length} Item(s) • <span className="font-bold text-neutral-900">₹{order.totalAmount.toFixed(2)}</span>
          </p>
        </div>
